...
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://DARKAMAN:DARKAMAN@cluster0.snqhn.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
OWNER_ID = getenv("OWNER_ID", "1793699293")
